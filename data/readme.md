...
- **baseball-reference.com/**  
  ...
  - See `encyclopedia.md` for a detailed description of each table and variable.
...
- Do not edit files in `clean/` directly; they are generated by the data_prepper module.
...
- For a full data dictionary and table explanations, see [`baseball-reference.com/encyclopedia.md`](baseball-reference.com/encyclopedia.md).
